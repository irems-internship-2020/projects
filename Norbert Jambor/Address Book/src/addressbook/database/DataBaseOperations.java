...
public class DataBaseOperations {
	...
	public void deleteDB(Contact contact) throws Exception{
		sql = " with delete_query as "
					+ "(DELETE FROM \"AddressBookSchema\".\"Contact\" "
					+ "WHERE contact_id = " +contact.getId() +"returning address_fk) "
		    + " DELETE FROM \"AddressBookSchema\".\"Address\" "
		    + " WHERE address_id IN (SELECT address_fk FROM delete_query)";
		establishConnection().executeUpdate(sql);
	}
