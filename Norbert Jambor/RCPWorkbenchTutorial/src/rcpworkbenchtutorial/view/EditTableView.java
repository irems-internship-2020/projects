...
import rcpworkbenchtutorial.comparator.MyViewerComparator;
import rcpworkbenchtutorial.tableedit.FirstNameEditingSupport;
import rcpworkbenchtutorial.tableedit.GenderEditingSupport;
import rcpworkbenchtutorial.tableedit.LastNameEditingSupport;
import rcpworkbenchtutorial.tableedit.MarriedEditingSupport;
    ...
    private void createColumns(final Composite parent, final TableViewer viewer) {
        ...
        col.setLabelProvider(new ColumnLabelProvider() {
            ...
            public Image getImage(Object element) {
                if (((Person) element).isMarried() != null) {
                    return CHECKED;
                } else {
                    return UNCHECKED;
                }
